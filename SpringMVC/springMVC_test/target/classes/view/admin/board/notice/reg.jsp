                    ...
                    <table class="table">
                        ...
                        <tr>
                            <select name="category">
                                ...
                                <option value="c4">카테고리4</option>
                            </select>
                        </tr>
                        <tr>
                            <input type="checkbox" value="짜장면" name="ch1"/>
                            <input type="checkbox" value="짬뽕" name="ch1"/>
                            <input type="checkbox" value="볶음밥" name="ch1"/>
                            <input type="checkbox" value="탕수육" name="ch1"/>
                        </tr>
                        <tr>
                            <input type="radio" value="짜장면" name="rad1">짜장면</input>
                            <input type="radio" value="짬뽕" name="rad1">짬뽕</input>
                            <input type="radio" value="볶음밥" name="rad1">볶음밥</input>
                            <input type="radio" value="탕수육" name="rad1">탕수육</input>
                        </tr>
                        </tbody>
                    </table>
                </div>
