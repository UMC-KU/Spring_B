...
public class UserController {
    ...
    public BaseResponse<GetUserInfoRes> getUserInfoByIdx(@PathVariable("userIdx")int userIdx) {
        try{

            GetUserInfoRes getUserInfoRes = userProvider.getUserInfoByIdx(userIdx);
