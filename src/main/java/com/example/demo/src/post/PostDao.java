...
public class PostDao {
    ...
    public List<GetPostsRes> selectPosts(int userIdx){
        ...
        return this.jdbcTemplate.query(selectPostsQuery,
                (rs, rowNum) -> new GetPostsRes(
                        ...
                        getPostImgRes = this.jdbcTemplate.query("select pi.postImgUrlIdx, pi.imgUrl from PostImgUrl as pi join Post as p on p.postIdx = pi.postIdx where pi.status = 'ACTIVE' and p.postIdx = ?;",
    ...
    public int checkPostExist(int postIdx) {
        String checkPostExistQuery = "select exists(select postIdx from User where userIdx = ?";
        int checkPostExistsParams = postIdx;
        return this.jdbcTemplate.queryForObject(checkPostExistQuery,
                int.class,
                checkPostExistsParams);
    }
    ...
    public int deletePost(int postIdx) {
        ...
        Object[] deletePostParmas = new Object[]{postIdx};
        return this.jdbcTemplate.update((updatePostQuery), deletePostParmas);
    }
